...
export const showcaseItems: ShowcaseItem[] = [
  ...
  },
  {
    ...
    description: 'See the true cost of "free" tools. Direct spend, data extraction value, lock-in scores, and switching costs — the number that changes conversations.',
    url: '/calculator',
